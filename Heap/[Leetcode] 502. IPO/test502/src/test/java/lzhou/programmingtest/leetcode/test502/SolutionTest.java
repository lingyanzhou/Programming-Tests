...
public class SolutionTest {
    @Parameters(name = "{index}: findMaximizedCapital({0},{1},{2},{3})={4}")
    ...
    public SolutionTest(int k, int W, int[] Profits, int[] Capital, int expected) {
        this.k = k;
        this.W = W;
    ...
    @Test
    public void test() {
        int actual = new Solution().findMaximizedCapital(k, W, Profits, Capital);
