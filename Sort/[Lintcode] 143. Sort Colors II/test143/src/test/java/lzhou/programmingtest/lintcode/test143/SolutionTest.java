...
public class SolutionTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] { 
                 ...
                 {new int[]{1,2,1,1,2}, 2, new int[]{1,1,1,2,2}},
                 {new int[]{1,3,2,3,2,3,1}, 3, new int[]{1,1,2,2,3,3,3}},
                 {new int[]{4,3,2,1}, 4, new int[]{1,2,3,4}},
           });
    }
    private int[] colors;
    private int k;
    ...
    public SolutionTest(int[] colors, int k, int[] expected) {
        this.colors = colors;
        this.k = k;
